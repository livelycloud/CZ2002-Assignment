...
public class Restaurant {
    ...
    public void loadMenuReference() {
        try {
            String fileName = "src/restaurant/MenuReference.txt";
    ...
    private void loadMenu() {
        try {
            String fileName = "src/restaurant/Menu.txt";
    ...
    private void loadOrder() {
        try {
            String fileName = "src/restaurant/activeOrders.txt";
    ...
    private void saveOrder() {
        ...
        try {
            ...
            for (Order curOrder : inactiveOrders) {
                String filename = "src/restaurant/historyOrders\\"
    ...
    private void loadStaff() {
        try {
            String fileName = "src/restaurant/staff.txt";
            BufferedReader br = new BufferedReader(new FileReader(fileName));
    ...
    public void loadhistoryOrders() {
        String pathName = "src/restaurant/historyOrders/";
